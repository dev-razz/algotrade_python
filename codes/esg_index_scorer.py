...
df = pd.read_csv('./data/nifty50_tickers - ind_nifty50list.csv') #give the full path of file downloaded
...
for ticker in index_tickers:
     ...
     try:
          if ticker_name.sustainability is not None: #if no response from Yahoo received, it will pass to next ticker
               ...
               time.sleep(randint(1,2)) #delaying the fetch of data for 2-8 seconds
